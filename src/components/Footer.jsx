...
function Footer() {
  return (
    <Motion.footer
      ...
      className="border-t border-slate-800 bg-slate-950/95 px-4 py-12 text-slate-300"
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-10 md:flex-row md:justify-between">
        ...
        <div className="grid flex-1 grid-cols-2 gap-8 text-sm md:grid-cols-3">
          <div className="space-y-3">
            <h4 className="text-xs font-semibold uppercase tracking-[0.25em] text-emerald-400">
              Quick Links
            </h4>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3 text-slate-400">
              ...
              <a href="#" aria-label="Facebook" className="hover:text-emerald-300">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="#" aria-label="YouTube" className="hover:text-emerald-300">
